...
def main():
    ...
    parser.add_argument("source_service", help="Source storage service (s3, s3-compatible, spaces, gcs, oss, azure)")
    parser.add_argument("source_bucket", help="Source bucket name")
    parser.add_argument("destination_service", help="Destination storage service (s3, s3-compatible, spaces, gcs, oss, azure)")
